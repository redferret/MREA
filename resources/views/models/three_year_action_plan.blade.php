...
@endsection
@section('content')
{{Form::body('loadPlan(ThreeyearActionPlan);')}}
<table id="mainTable">
  <tbody>
    <tr>
  ...
  <tbody id='tabletitle'>
    <tr>
      <th colspan='6' id='title'>Three Year Action Plan</th>
      <th colspan='2' id='agent'>
  ...
  <tbody>
    ...
    <tr>
      <th style='text-align: left; border-bottom: none'>Yearly:</th>
      <th colspan='3' style='text-align: left'>Added to Database</th>
      <th class='redCell'>
    ...
    <tr class='tableBanner'>
      <th></th>
      <th colspan='7' style='text-align: left'>Three Year Organization Model</th>
    </tr>
    <tr>
    ...
    <tr style='background: #FFFF99'>
      <th colspan='8'>
        <textarea rows='16' cols="88" id="f1" formatting='s!' class='textArea'
                  onchange='updateAndPost(this, ThreeyearActionPlan, "ThreeYearActionPlan");'></textarea>
      </th>
    </tr>
  </tbody>
</table>
